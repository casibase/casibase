export const FONTS_LIST  = [
    ...
    {label: "Avenir Next", value: "1"},
    {label: "Helvetica", value: "2"},
    {label: "Helvetica Neue", value: "3"},
    {label: "Lucida Grande", value: "4"},
    {label: "Myriad Pro", value: "5"},
    {label: "Segoe UI", value: "6"},
    {label: "Comic Sans MS", value: "7"},
    {label: "Menlo", value: "8"},
    {label: "Panic Sans", value: "9"},
    {label: "JetBrains Mono", value: "10"},
    {label: "Fira Code", value: "11"},
]
