                    ...
                    <div style={{marginLeft: isChild ? "48px" : "60px"}}>
                        <div className="fr">
                            {this.props.account !== null && this.props.account !== undefined && this.props.account.id !== reply?.author ? (
                                reply?.thanksStatus === false ? (
                                    <div id={`thank_area__${reply.id}`} className="thank_area"
                                        ...
                                        {/*</a>*/}
                                        <a onClick={() => this.thanksReply(reply.id, reply.author)}
                                           className="thank link-btn">
                                            {Setting.PcBrowser ? i18next.t("reply:thank") :
                                                <img src={Setting.getStatic("/img/heart_neue.png")} width="16"
                                                     style={{verticalAlign: "bottom"}} alt={i18next.t("reply:thank")}/>}
                                        </a>
                                    </div>
                                ) : (
                            ...
                            {reply?.deletable ? (
                                <div id={`thank_area__${reply.id}`} className="thank_area"
                                     style={{marginRight: "10px"}}>
                                    <a className="delete link-btn" style={{marginRight: "10px"}}
                            ...
                            {this.props.account !== undefined && this.props.account !== null ? (
                                <a
                                    ...
                                    style={{marginRight: "10px"}}
                                >
                                    <img src={Setting.getStatic("/img/reply_neue.png")} align="absmiddle" border="0"
                                         alt="Reply" width="20"/>
                                </a>
                            ) : null}
        ...
        return (
            <div>
                {this.state.replies.length === 0 ?
                    <div id="no-comments-yet">{i18next.t("reply:No reply yet")}</div> : this.renderReply()}
