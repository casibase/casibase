            ...
            <div>
                ...
                <div className="inner" id="topic_preview">
                    <div className="topic_content">
                        <div className="markdown_body">{!this.state.isPreviewEnabled ? null :
                            <ReactMarkdown source={this.state.form.body} escapeHtml={false}/>}</div>
                    </div>
                </div>
            </div>
        );
          ...
          >
            {this.state.form.title}
                    ...
                    <div style={{display: "flex", justifyContent: "space-between"}}>
                        <input type="submit" value={i18next.t("node:Publish")} className="super normal button"
                ...
                <div className="inner">
                    <div className="fr">
                        ...
                        &nbsp; <span
                        className="fade">{i18next.t("node:Topics in the ignored nodes will not appear on the homepage.")}</span>
                    </div>
                    &nbsp;
                </div>
            </div>
                        ...
                        &nbsp;Auto Tag
                            ...
                            <td style={{display: "flex", justifyContent: "space-between"}}>
                                <div>
                                    ...
                                    <button type="button" className="super normal button"
                                    ...
                                    {" "}
                                    &nbsp;
                                    <button type="submit" className="super normal button"
                                            onClick={this.publishTopic.bind(this)}>
