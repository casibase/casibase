...
class AllCreatedTopicsBox extends React.Component {
    ...
    showPageColumn(url) {
        ...
        return <PageColumn page={this.state.page} total={this.state.topicsNum} url={url}
            ...
            return (
                <div className="box">
                    <div className="header">
                        ...
                        className="chevron">&nbsp;›&nbsp;</span> {i18next.t("member:All Topics")}
                        <div className="fr f12">
                            <span className="snow">{i18next.t("member:Total Topics")}&nbsp;</span> <strong
                            className="gray">{this.state.topicsNum}</strong>
                        </div>
                    </div>
            ...
            <div className="box">
                ...
                {this.state.tab === undefined ? (
                    <div className="inner">
                        <span className="chevron">»</span>
                        <Link
                            to={`/member/${this.state.memberId}/topics`}> {`${this.state.memberId}${i18next.t("member:'s more topics")}`} </Link>
                    </div>
                ) : null}
            </div>
        );
