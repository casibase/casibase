...
class FilesBox extends React.Component {
    ...
    renderUpload() {
        ...
        <div className="box">
          <div className="header">
            <Link to="/">{Setting.getForumName()}</Link> <span className="chevron">&nbsp;›&nbsp;</span> <Link
              to="/i">Files</Link> <span className="chevron">&nbsp;›&nbsp;</span> {i18next.t("file:Upload new file")}
          </div>
            {this.renderProblem()}
            <div className="cell">
    ...
    renderFile() {
        ...
        return (
            <div className="box">
                <div className="header">
                    <Link to="/">{Setting.getForumName()}</Link> <span className="chevron">&nbsp;›&nbsp;</span> <Link
                    to="/i?p=1">Files</Link> <span className="chevron">&nbsp;›&nbsp;</span> {file?.fileName}
                </div>
            ...
            {file?.fileType === "image" ? (
                ...
                {this.state.fileWidth}𝖷{this.state.fileHeight} &nbsp;·&nbsp;
                        ...
                        <Link to={`/member/${file?.memberId}`}>{file?.memberId}</Link> {i18next.t("file:upload")}{" "}
                ...
                <div className="cell_ops">
                    <div className="fr">
                        <input type="button" value={i18next.t("file:Delete")} className="super normal button"
                               onClick={() => this.deleteFile(file)}/>
                    </div>
                    <input type="button" value={i18next.t("file:Edit information")} className="super normal button"
    ...
    renderEditFile() {
        ...
        return (
            <div className="box">
                <div className="header">
                    <Link to="/">{Setting.getForumName()}</Link> <span className="chevron">&nbsp;›&nbsp;</span> <Link
                    to="/i">Files</Link> <span className="chevron">&nbsp;›&nbsp;</span> <Link
                    to={`/i/${file?.id}`}>{file?.fileName}</Link>{" "}
                        ...
                        <tr>
                            <td width="160" valign="top" align="center" className="image-edit-left">
                                {file?.fileType === "image" ? (
                                    ...
                                    <Link to={`/i/${file?.id}`} target="_blank">
                                        <div
                                            style={{lineHeight: "100px"}}>{i18next.t("file:No preview for this type of file")}</div>
                                    </Link>
                                )}
                                <div className="inner">
                                    {file?.fileType === "image" ? (
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="text" className="sl" name="title" maxLength="64"
                                                   style={{width: "100%"}} value={this.state.form.fileName}
                                                   onChange={(event) => this.updateFormField("fileName", event.target.value)}/>
                                            <div className="sep10"></div>
                                            {i18next.t("file:Description")}
                                            <div className="sep5"></div>
                                            <textarea className="ml" style={{width: "100%"}} name="description"
                                                      maxLength="1000"
                                                      onChange={(event) => this.updateFormField("desc", event.target.value)}
                                                      value={this.state.form.desc}/>
                                            <div className="sep10"></div>
                                            <input type="submit" value={i18next.t("file:submit")}
                                                   className="super normal button" onClick={() => this.editDesc()}/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
    ...
    showPageColumn() {
        ...
        return <PageColumn page={this.state.page} total={this.state.filesNum} url={this.state.url}
        ...
        return (
            <div className="box">
                <div className="header">
                    ...
                    className="chevron">&nbsp;›&nbsp;</span> {i18next.t("error:File not found")}
                </div>
                <div className="cell">
    ...
    renderFileLoading() {
        ...
        return (
            <div className="box">
                <div className="header">
                    <Link to="/">{Setting.getForumName()}</Link> <span
                    className="chevron">&nbsp;›&nbsp;</span> {i18next.t("loading:File is loading")}
                </div>
                <div className="cell">
