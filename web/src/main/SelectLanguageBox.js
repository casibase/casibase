            ...
            <div align="center">
                <div className="box" style={{width: Setting.PcBrowser ? "600px" : "auto"}}>
                    <div className="header">
                        ...
                        className="chevron">&nbsp;›&nbsp;</span> Select Language / 选择语言
                    </div>
                    <div className="cell">{Setting.PcBrowser ?
                        <span>Please select the language you would like to use on {Setting.getForumName()}</span> :
                        <span>Please select the language you would like to use:</span>}</div>
