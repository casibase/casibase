...
class NewReplyBox extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={["box", this.props.sticky ? "sticky" : "", `${this.props.nodeId}`].join(" ")}
                 id="reply-box">
                <div style={blurStyle} className={`cell ${this.props.nodeId}`}>
                    <div className="fr">
                        {this.props.parent?.id > 0 ? (
                            <a onClick={this.props.cancelReply.bind(this)}
                               style={{display: this.props.sticky ? "" : "none"}} id="cancel-button"
                               className={`${this.props.nodeId}`}>
                                {i18next.t("reply:Cancel reply to {username}").replace("{username}", this.props.parent.username)}
                            </a>
                        ) : null}{" "}
                        &nbsp; &nbsp;{" "}
                        <a onClick={this.undockBox.bind(this)} style={{display: this.props.sticky ? "" : "none"}}
                           id="undock-button" className={`${this.props.nodeId}`}>
                ...
                <div className={`cell ${this.props.nodeId}`}>
                    ...
                    >
                        <input style={blurStyle} onClick={this.publishReply.bind(this)} type="submit"
                               value={i18next.t("reply:Reply")} className="super normal button"/>
