              ...
              <tr>
                ...
                <td width="auto" align="left">
                  <input
                    ...
                    name="affiliation"
                    onChange={(event) =>
                      this.updateFormField("affiliation", event.target.value)
                    }
                    autoComplete="off"
                  />
                </td>
              ...
              <tr>
                ...
                <td width="auto" align="left">
                  <input
                    ...
                    maxLength="20"
                    onChange={(event) =>
                      this.updateFormField("tag", event.target.value)
                    }
                    autoComplete="off"
                  />
                </td>
              ...
              <tr>
                ...
                <td width="auto" align="left">
                  <input
                    ...
                    maxLength="32"
                    onChange={(event) => {
                      let properties = this.state.form.properties;
                      if (properties === undefined) {
                        properties = {};
                      }
                      properties["location"] = event.target.value;
                      this.updateFormField("properties", properties);
                    }}
                    autoComplete="off"
                  />
                </td>
