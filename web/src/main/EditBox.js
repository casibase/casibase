            ...
            return (
                <div className="box">
                    <div className="header">
                        ...
                        className="chevron">&nbsp;›&nbsp;</span> {i18next.t("loading:Content loading")}
                    </div>
                    <div className="cell">
        ...
        if (this.state.editObject === null || !this.state.editObject?.editable) {
            return (
                <div className="box">
                    <div className="header">
                        <Link to="/">{Setting.getForumName()}</Link> <span
                        className="chevron">&nbsp;›&nbsp;</span> {i18next.t("edit:Edit content")}
                    </div>
        ...
        return (
            <div className="box">
                <div className="header">
                    ...
                    <Link
                        to={`/go/${encodeURIComponent(this.state.editObject?.nodeId)}`}> {this.state.editObject?.nodeName}</Link>
                ...
                <div className="cell">
                  ...
                  />
                        ...
                        <tr>
                            ...
                            <td style={{display: "flex", justifyContent: "space-between"}}>
                                <div>
                                    <input type="submit" value={i18next.t("edit:Save")} className="super normal button"
