...
class EditBox extends React.Component {
  ...
  getEditObject() {
    if (this.state.editType === "topic") {
      TopicBackend.getTopic(this.state.objectId)
        .then((res) => {
          this.setState({
            editObject: res,
          }, () => {
        ...
        <div className="box">
          ...
          <div className="cell">
            <table cellPadding="5" cellSpacing="0" border="0" width="100%">
              ...
              <tr>
                <td>
                  <div style={{overflow: "hidden", overflowWrap: "break-word", resize: "none", height: "320"}}
                       name="content" className="mle tall" id="reply_content">
                    <Resizable
                      enable={false}
                      defaultSize={{
                        width: 730,
      ...
      <div class="box">
        ...
        <div class="cell">
          <table cellpadding="5" cellspacing="0" border="0" width="100%">
            ...
            <tr>
              <td>
                <textarea type="text" maxLength="120" name="title" class="mle" name="title" value={this.state.form.title} onChange={event => {this.updateFormField("title", event.target.value)}}>
                </textarea>
              </td>
            </tr>
            <tr>
              <td>
                <div style={{overflow: "hidden", overflowWrap: "break-word", resize: "none", height: "320"}} name="content" class="mle tall" id="topic_content" >
                  <Resizable
                    enable={false}
                    defaultSize={{
                      width: 730,
