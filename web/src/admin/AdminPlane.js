        ...
        return (
            <div className="box">
                <div className="header">
                    ...
                    <Link to={`/admin/plane`}>{i18next.t("plane:Plane management")}</Link> <span
                    className="chevron">&nbsp;›&nbsp;</span>
                ...
                <span style={{fontSize: "13px"}}>
                  {plane?.nodesNum} {i18next.t("plane:nodes")}
                        ...
                        <td width={pcBrowser ? "120" : "80"} align="left" style={{textAlign: "center"}}>
                            {plane?.visible ? <span className="positive">{i18next.t("plane:Visible")}</span> :
                            ...
                            <div className="inner">
                                <table cellPadding="5" cellSpacing="0" border="0" width="100%">
                                    ...
                                    {newPlane ? (
                                        <tr>
                                            ...
                                            <td width="auto" align="left">
                                                <input type="text" className="sl" name="id" id="plane_id"
                                                       value={this.state.form?.id}
                                                       onChange={(event) => this.updateFormField("id", event.target.value)}
                                                       autoComplete="off"/>
                                            </td>
                                        </tr>
                                    ) : null}
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            <input type="text" className="sl" name="name" id="plane_name"
                                                   value={this.state.form?.name === undefined ? "" : this.state.form?.name}
                                                   onChange={(event) => this.updateFormField("name", event.target.value)}
                                                   autoComplete="off"/>
                                        </td>
                                    </tr>
                                    {!newPlane ? (
                                    ...
                                    {!newPlane ? (
                                        <tr>
                                            ...
                                            <td width="auto" align="left">
                                                <span
                                                    className="gray">{this.state.plane?.nodes.length !== 0 ? this.state.plane?.nodes.map((node) => this.renderNode(node)) : i18next.t("plane:No node yet")}</span>
                                            </td>
                                        </tr>
                                    ) : null}
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            <input type="range" min="1" max="1000" step="1"
                                                   value={this.state.form?.sorter === undefined ? 1 : this.state.form?.sorter}
                                                   onChange={(event) => this.updateFormField("sorter", parseInt(event.target.value))}/>
                                            &nbsp; &nbsp; <input type="number" name="sorter" min="1" max="1000" step="1"
                                                                 value={this.state.form?.sorter} style={{width: "50px"}}
                                                                 onChange={(event) => this.updateFormField("sorter", parseInt(event.target.value))}/>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            <span
                                                className="gray">{i18next.t("plane:Decide the order of node navigation")}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="120" align="right">
                                        ...
                                        <td width="auto" align="left">
                                            <input type="radio" onClick={() => this.updateFormField("visible", true)}
                                                   checked={this.state.form?.visible} name="visible"/>
                                            {i18next.t("plane:Visible")} <input type="radio"
                                    ...
                                    {!this.state.form.visible ? (
                                        <tr>
                                            ...
                                            <td width="auto" align="left">
                                                <span
                                                    className="gray">{i18next.t("plane:This plane will not appear on the node navigation")}</span>
                                            </td>
                                        </tr>
                                    ) : null}
                                    <tr>
                                        <td width="120" align="right"></td>
                                        <td width="auto" align="left">
                                            {!newPlane ? <input type="submit" className="super normal button"
                                                                value={i18next.t("plane:Save")}
                                                                onClick={() => this.updatePlaneInfo()}/> : null}
                                        </td>
                                    </tr>
                                    {newPlane ? (
                                        <tr>
                                            ...
                                            <td width="auto" align="left">
                                                <span
                                                    className="gray">{i18next.t("plane:Please go to the display page to continue to improve the information and submit")}</span>
                                            </td>
                                        </tr>
                                    ) : null}
                                    </tbody>
                        ...
                        <div className="inner">
                            <table cellPadding="5" cellSpacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        {this.state.form?.image === undefined || this.state.form?.image === "" ? (
                                            ...
                                            <Zmage src={this.state.form?.image} alt={this.state.form?.id}
                                ...
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        <input type="text" className="sl" name="image" id="change_image"
                                               value={this.state.form?.image === undefined ? "" : this.state.form?.image}
                                               onChange={(event) => this.updateFormField("image", event.target.value)}
                                               autoComplete="off"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        ...
                                        {this.state.displayColorPicker ? (
                                            ...
                                            >
                                                ...
                                                />
                                                <SketchPicker color={this.state.form.color}
                                                              onChange={(color) => this.handleColorChange(color, "color")}/>
                                            </div>
                                        ) : null}{" "}
                                        &nbsp;{" "}
                                        {!newPlane ? (
                                    ...
                                    <td width="auto" align="left">
                                        ...
                                        {this.state.displayBackgroundColorPicker ? (
                                            ...
                                            >
                                                ...
                                                />
                                                <SketchPicker color={this.state.form.backgroundColor}
                                ...
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        ...
                                        >
                                            <img src={this.state.form?.image} border="0" align="absmiddle"
                                                 width="24"/> &nbsp; {this.state.form?.name}
                                            <span
                                                className="fr"
                                                style={{
                                                    color: this.state.form?.color,
                                            ...
                                            >
                          {this.state.form?.id} • {!newPlane ?
                                                <span className="small">{plane?.nodesNum} nodes</span> : null}
                        </span>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        {newPlane ? (
                                            <input type="submit" className="super normal button"
