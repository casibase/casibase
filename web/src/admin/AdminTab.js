        ...
        return (
            <div className="box">
                <div className="header">
                    ...
                    <Link to={`/admin/tab`}>{i18next.t("tab:Tab management")}</Link> <span
                    className="chevron">&nbsp;›&nbsp;</span>
                        ...
                        <div className="inner">
                            <table cellPadding="5" cellSpacing="0" border="0" width="100%">
                                ...
                                {newTab ? (
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            <input type="text" className="sl" name="id" id="tab_id"
                                ...
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        <input type="text" className="sl" name="name" id="tab_name"
                                ...
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        <span
                                            className="gray">{i18next.t("tab:Decide the order of node navigation and homepage")}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="120" align="right">
                                    ...
                                    <td width="auto" align="left">
                                        <input type="radio" onClick={() => this.updateFormField("homePage", true)}
                                               checked={this.state.form?.homePage} name="homePage"/>
                                        {i18next.t("tab:show")} <input type="radio"
                                    ...
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            {tab?.nodesNum !== 0 && tab?.nodesNum !== undefined ? (
                                                ...
                                                <span
                                                    className="gray">{i18next.t("tab:No node exists in this tab")}</span>
                                            )}
                                        </td>
                                    </tr>
                                ) : null}
                                {this.state.form?.homePage ? (
                                    <tr>
                                        ...
                                        <td width="auto" align="left">
                                            <span
                                                className="gray">{i18next.t("tab:The default node when creating a topic on the homepage")}</span>
                                        </td>
                                    </tr>
                                ) : null}
                                <tr>
                                    ...
                                    <td width="auto" align="left">
                                        {!newTab ? (
                                            <input type="submit" className="super normal button"
                                                   value={i18next.t("tab:Save")} onClick={() => this.updateTabInfo()}/>
                                        ) : (
                                            <input type="submit" className="super normal button"
                                                   value={i18next.t("tab:Create")} onClick={() => this.postNewTab()}/>
                                        )}
                                    </td>
                                </tr>
                                </tbody>
