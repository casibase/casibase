...
import {BulbOutlined, CheckOutlined, HighlightOutlined, ShrinkOutlined} from "@ant-design/icons";

export const Themes = [
  {label: "Default", key: "default", icon: <BulbOutlined style={{fontSize: "24px"}} />},        // i18next.t("theme:Default")
  {label: "Dark", key: "dark", icon: <HighlightOutlined style={{fontSize: "24px"}} />},          // i18next.t("theme:Dark")
