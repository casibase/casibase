            ...
            <div className={`box ${this.props.nodeId}`}>
                    ...
                    <table cellPadding="0" cellSpacing="0" border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="auto" align="left">
                                <div className="fr light-toggle" style={{cursor: "pointer"}}
                        ...
                        <tr>
                            <td width="33%" align="center">
                                <Link to="/my/nodes" className="dark" style={{display: "block"}}>
                                    <span
                                        className="bigger">{favorites === undefined ? this.state.nodeFavoriteNum : favorites[3]}</span>
                                    <div className="sep3"/>
                            ...
                            >
                                <Link to="/my/topics" className="dark" style={{display: "block"}}>
                                    <span
                                        className="bigger">{favorites === undefined ? this.state.topicFavoriteNum : favorites[1]}</span>
                                    <div className="sep3"/>
                            ...
                            <td width="33%" align="center">
                                <Link to="/my/following" className="dark" style={{display: "block"}}>
                                    <span
                                        className="bigger">{favorites === undefined ? this.state.followingNum : favorites[2]}</span>
                                    <div className="sep3"/>
                ...
                <div className={`cell ${this.props.nodeId}`} style={{padding: "8px", lineHeight: "100%"}}>
                    <table cellPadding="0" cellSpacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td width="28">
                                <Link to="/i">
                                    <img src={Setting.getStatic("/img/essentials/images.png")} width="28" border="0"
                ...
                <div className={`cell ${this.props.nodeId}`} style={{padding: "8px", lineHeight: "100%"}}>
                    <table cellPadding="0" cellSpacing="0" border="0" width="100%">
                        ...
                        <tr>
                            <td width="28">
                                <Link to="/new">
                                    <img src={Setting.getStatic("/img/essentials/compose.png")} width="28" border="0"
                                         style={{verticalAlign: "bottom"}}/>
                                </Link>
                            </td>
                            <td width="10"/>
                ...
                <div className="inner">
                  ...
                  {" "}
                            ...
                            {silverCount} <img src={Setting.getStatic("/img/silver@2x.png")} height="16" alt="S"
                                               border="0"/> {bronzeCount} <img
                            src={Setting.getStatic("/img/bronze@2x.png")} height="16" alt="B" border="0"/>
                        </Link>
                    </div>
              ...
              <img src={Setting.getStatic("/img/dot_orange.png")} align="absmiddle"/>{" "}
                    ...
                    {this.state.unreadNotificationNum === 0 ? (
                        ...
                        <strong>
                            <Link onClick={() => this.readAllNotifications()} to="/notifications"
