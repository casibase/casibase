...
class ContainerListPage extends BaseListPage {
  ...
  renderTable(containers) {
    const columns = [
      ...
      {
        title: i18next.t("general:DisplayName"),
      ...
      {
        title: i18next.t("general:SizeRw"),
        dataIndex: "sizeRw",
        key: "sizeRw",
        width: "120px",
      ...
      {
        title: i18next.t("general:SizeRootFs"),
      ...
      {
        title: i18next.t("container:State"),
        dataIndex: "state",
        key: "state",
        width: "120px",
      ...
      {
        title: i18next.t("container:Status"),
        dataIndex: "status",
        key: "status",
        width: "120px",
