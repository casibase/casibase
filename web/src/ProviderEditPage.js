  ...
  renderProvider() {
    return (
      <Card size="small" title={
        ...
        {
          (this.state.provider.category === "Model" && (this.state.provider.type === "Local" || this.state.provider.type === "Ollama")) ? (
            <>
              <Row style={{marginTop: "20px"}} >
                <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
                  {i18next.t("provider:InputPricePer ThousandTokens")}:
                </Col>
                <Col span={22} >
              ...
              <Row style={{marginTop: "20px"}} >
                <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
                  {i18next.t("provider:OutputPricePer ThousandTokens")}:
                </Col>
                <Col span={22} >
        ...
        {
          (this.state.provider.category === "Embedding" && (this.state.provider.type === "Local" || this.state.provider.type === "Ollama")) ? (
            <>
              <Row style={{marginTop: "20px"}} >
                <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
                  {i18next.t("provider:PricePer ThousandTokens")}:
                </Col>
                <Col span={22} >
                  <Input value={this.state.provider.pricePerThousandTokens} onChange={e => {
                    this.updateProviderField("pricePerThousandTokens", e.target.value);
                  }} />
                </Col>
              </Row>
            </>
