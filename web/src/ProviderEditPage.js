  ...
  renderProvider() {
    return (
      <Card size="small" title={
        ...
        {
          (this.state.provider.category === "Model" && ["OpenAI", "OpenRouter", "iFlytek", "Hugging Face", "Ernie", "MiniMax", "Gemini", "Qwen", "Baichuan", "Doubao", "StepFun"].includes(this.state.provider.type)) ? (
            <>
              <Row style={{marginTop: "20px"}}>
                <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
                ...
                <this.InputSlider
                  min={0}
                  max={["Qwen", "Gemini", "OpenAI", "OpenRouter", "Baichuan", "StepFun"].includes(this.state.provider.type) ? 2 : 1}
                  step={0.01}
        ...
        {
          (this.state.provider.category === "Model" && ["OpenAI", "OpenRouter", "Ernie", "Gemini", "Qwen", "Baichuan", "Doubao", "StepFun"].includes(this.state.provider.type)) ? (
            <>
              <Row style={{marginTop: "20px"}}>
                <Col style={{marginTop: "5px"}} span={(Setting.isMobile()) ? 22 : 2}>
