...
export default function DataWorkBench(props) {
    ...
    const selectedHasImage = (() => {
        try {
            ...
            return String(selectedDatasetName).includes('影像') || String(selectedDatasetName).includes('肺疾病');
                        ...
                        {selectedData === 'image' ? (
                            <div >
                                ...
                                <div style={{
                                    ...
                                    {/* 示例影像卡片数据，可替换为真实数据 */}
                                    {[
                                        { id: 'ECG001', patient: 'P001', date: '2025-09-10', src: './sample/sample_lr_input.png' },
                                        { id: 'ECG002', patient: 'P002', date: '2025-09-08', src: './sample/sample_lr_input.png' },
                                        { id: 'ECHO003', patient: 'P003', date: '2025-09-11', src: './sample/sample_lr_input.png' }
                                    ].map(item => {
                                        // 判断是否已超分
