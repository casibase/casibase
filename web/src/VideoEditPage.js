              ...
              options={[
                {
                  label: (
                    <div style={{padding: 4}}>
                      <Avatar src={"https://cdn.casibase.org/img/email_mailtrap.png"} />
                            &nbsp;
                ...
                },
                {
                  label: (
                    <div style={{padding: 4}}>
                      <Avatar src={"https://cdn.casibase.org/img/social_slack.png"} />
                            &nbsp;
                ...
                },
                {
                  label: (
                    <div style={{padding: 4}}>
                      <Avatar src={"https://cdn.casibase.org/img/social_yandex.png"} />
                            &nbsp;
                ...
                },
                {
                  label: (
                    <div style={{padding: 4}}>
                      <Avatar src={"https://cdn.casibase.org/img/social_cloudflare.png"} />
                            &nbsp;
                ...
                },
                {
                  label: (
                    <div style={{padding: 4}}>
                      <Avatar src={"https://cdn.casibase.org/img/social_openai.svg"} />
                            &nbsp;
