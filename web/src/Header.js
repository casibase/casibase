                        ...
                        <div id="user-menu" style={menuStyle}>
                            ...
                            <div>
                                <a target="_blank" className="top" href={Setting.getMyResourcesUrl(this.props.account)}>
                                    <img src={Setting.getStatic("/img/neue_image.png")} height="14" border="0"
                                         align="absmiddle"/> &nbsp;{i18next.t("bar:File library")}
                                </a>
                            </div>
                            <div>
                                <Link to="/notes" className="top">
                                    <img src={Setting.getStatic("/img/neue_notepad.png")} height="14" border="0"
                                         align="absmiddle"/> &nbsp;{i18next.t("general:Note")}
                                </Link>
                            </div>
                            <div>
                                <Link to="/t" className="top">
                                    <img src={Setting.getStatic("/img/neue_comment.png")} height="14" border="0"
                                         align="absmiddle"/> &nbsp;{i18next.t("general:Timeline")}
                                </Link>
                            </div>
                            <div className="menu_sep"></div>
                            <div>
