...
class TopicPage extends React.Component {
  constructor(props) {
    super(props);
    const ROOT_TAB_ID = 'all';
    let lastTabOpen = localStorage.getItem('casbin-forum-lastTabOpen');
    this.state = {
      classes: props,
      topics: [],
      defaultHomePageNum: 50,
      tabs: [],
      tab: lastTabOpen !== null ? lastTabOpen : ROOT_TAB_ID,
      tabInfo: null,
      nodes: [],
    };
  ...
  changeTab(tab) {
    this.setState(
      ...
      () => {
        ...
        localStorage.setItem('casbin-forum-lastTabOpen', tab);
        this.getNodeInfo();
        this.getTopics();
      }
    );
