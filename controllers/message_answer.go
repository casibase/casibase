...
func (c *ApiController) GetMessageAnswer() {
	...
	if agentClients != nil {
		...
		modelResult, err = model.QueryTextWithTools(modelProviderObj, question, writer, history, promptToUse, knowledge, agentInfo)
	} else {
		modelResult, err = modelProviderObj.QueryText(question, writer, history, promptToUse, knowledge, nil)
	}
