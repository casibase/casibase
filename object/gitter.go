...
const (
	...
	RoomURL       = "https://gitter.im/casbin/gsoc"
	TopicDuration = time.Hour * 4
)
...
func SyncGitter() {
	...
	for _, v := range rooms { // find RoomId by url
		if "https://gitter.im/"+v.URI == RoomURL {
			room = v
			break
		}
	}
