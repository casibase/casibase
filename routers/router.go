...
func initAPI() {
	...
	beego.Router("/api/get-global-files", &controllers.ApiController{}, "GET:GetGlobalFileLists")
	beego.Router("/api/get-files", &controllers.ApiController{}, "GET:GetFileLists")
	beego.Router("/api/get-file", &controllers.ApiController{}, "GET:GetFileList")
	beego.Router("/api/update-file-list", &controllers.ApiController{}, "POST:UpdateFileList")
	beego.Router("/api/add-file-list", &controllers.ApiController{}, "POST:AddFileList")
	beego.Router("/api/delete-file-list", &controllers.ApiController{}, "POST:DeleteFileList")
