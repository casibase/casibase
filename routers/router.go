...
func initAPI() {
	...
	beego.Router("/api/query-blockchain-commit", &controllers.ApiController{}, "POST:QueryBlockchainCommit")
	...
	beego.Router("/api/upload-collaboration-pdf", &controllers.ApiController{}, "POST:UploadCollaborationPdf")
	beego.Router("/api/get-collaboration-pdf", &controllers.ApiController{}, "GET:GetCollaborationPdf")
	// Collaboration Knowledge APIs (知识上链)
	beego.Router("/api/create-collaboration-knowledge-request", &controllers.ApiController{}, "POST:CreateCollaborationKnowledgeRequest")
	beego.Router("/api/get-collaboration-knowledge-requests-by-doctor", &controllers.ApiController{}, "GET:GetCollaborationKnowledgeRequestsByDoctor")
	beego.Router("/api/get-collaboration-knowledge-requests-by-hospital", &controllers.ApiController{}, "GET:GetCollaborationKnowledgeRequestsByHospital")
	beego.Router("/api/get-collaboration-knowledge-requests-by-target-doctor", &controllers.ApiController{}, "GET:GetCollaborationKnowledgeRequestsByTargetDoctor")
	beego.Router("/api/submit-share-knowledge", &controllers.ApiController{}, "POST:SubmitShareKnowledge")
	beego.Router("/api/get-shared-knowledge-by-request", &controllers.ApiController{}, "GET:GetSharedKnowledgeByRequest")
