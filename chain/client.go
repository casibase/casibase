...
type ChainClientInterface interface {
	CommitWithMethodAndContractName(data, funcName, contractName,lang string) (string, string, string, error)
	QueryWithMethodAndContractName(data, funcName, contractName, lang string) (string, string, error)
